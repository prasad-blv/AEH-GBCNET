...
def parse():
    ...
    parser.add_argument('--img_dir', dest="img_dir", default="/content/drive/MyDrive/GBCU/imgs")
    parser.add_argument('--set_dir', dest="set_dir", default="/content/drive/MyDrive/GBCU")
    ...
    parser.add_argument('--meta_file', dest="meta_file", default="/content/drive/MyDrive/GBCU/roi_pred.json")
